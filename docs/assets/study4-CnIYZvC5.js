...
    }\r
  }\r
};`})]),_:1}),e[5]||(e[5]=t("h2",null,"Task List in Action",-1)),e[6]||(e[6]=t("img",{src:F,alt:"Example of task list application"},null,-1)),e[7]||(e[7]=t("h2",null,"Try It Yourself",-1)),t("div",A,[j(t("input",{"onUpdate:modelValue":e[0]||(e[0]=s=>r.newTask=s),type:"text",placeholder:"Enter a description of the task"},null,512),[[B,r.newTask]]),t("button",{onClick:e[1]||(e[1]=(...s)=>i.addTask&&i.addTask(...s))},"Add Task"),(d(!0),k(E,null,D(r.tasks,(s,p)=>(d(),k("div",{key:p,class:"task"},[t("span",{class:L({completed:s.completed})},u(s.description),3),t("button",{onClick:z=>i.toggleTask(p)},u(s.completed?"Undo":"Complete"),9,J)]))),128))])]),_:1}),o(f,{week:"2",num:"4"})]),_:1})}const X=S(I,[["render",N],["__scopeId","data-v-62367d3e"]]);export{X as default};
